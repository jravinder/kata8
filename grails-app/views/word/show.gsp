            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="word.dictionaryWord.label" default="Dictionary Word" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: wordInstance, field: "dictionaryWord")}</td>
