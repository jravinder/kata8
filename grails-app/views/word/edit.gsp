                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="dictionaryWord"><g:message code="word.dictionaryWord.label" default="Dictionary Word" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: wordInstance, field: 'dictionaryWord', 'errors')}">
                                    <g:textField name="dictionaryWord" value="${wordInstance?.dictionaryWord}" />
                                </td>
                            </tr>
